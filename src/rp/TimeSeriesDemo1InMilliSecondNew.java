...
public class TimeSeriesDemo1InMilliSecondNew extends JPanel {
     ...
     */
    public TimeSeriesDemo1InMilliSecondNew(String title, double[] dataArrayNew, Date[] timeDateSeries) {
    ...
    public void setPlotListener(MyPlotListener myPlotListener){
        this.myPlotListener = myPlotListener;
    }

    public void setData(String title, double[] dataArrayNew, Date[] timeDateSeries){
        this.dataArrayNew = dataArrayNew;
        this.timeDateSeries = timeDateSeries;
        numberOfPoints = dataArrayNew.length;
        this.setBackground(Color.white);
